...
else if selected_account.balance > 0
and selected_account.balance <= 200 then account_level := 'Standard';
elsif selected_account.balance > 200
and selected_account.balance <= 400 then account_level := 'Silver';
elsif selected_account.balance > 400
and selected_account.balance <= 600 then account_level := 'Gold';
else account_level := 'Platinum';
end if;
